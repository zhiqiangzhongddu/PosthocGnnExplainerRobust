        ...
        # Otherwise, run both functions in separation.
            ...
            if self._explain:
                ...
                if out.size(self.node_dim) != edge_mask.size(0):
                    ...
                    # my edit
                    add = out.size(self.node_dim) - edge_mask.size(0)
                    loop = edge_mask.new_ones(add)
...
def load_gnn_model(args, dataset):

    if args.gnn_model == "GCN_2l":
        model = GCN_2l(
            model_level="graph",
            dim_node=dataset.num_node_features, dim_hidden=args.gnn_hid_dim, num_classes=dataset.num_classes
        )
    elif args.gnn_model == "GCN_2l_BN":
        model = GCN_2l_BN(
            model_level="graph",
            dim_node=dataset.num_node_features, dim_hidden=args.gnn_hid_dim, num_classes=dataset.num_classes
        )
    elif args.gnn_model == "GCN_3l":
        model = GCN_3l(
            model_level="graph",
            dim_node=dataset.num_node_features, dim_hidden=args.gnn_hid_dim, num_classes=dataset.num_classes
        )
    elif args.gnn_model == "GCN_3l_BN":
        model = GCN_3l_BN(
            model_level="graph",
            dim_node=dataset.num_node_features, dim_hidden=args.gnn_hid_dim, num_classes=dataset.num_classes
        )
    elif args.gnn_model == "GIN_2l":
        model = GIN_2l(
            model_level="graph",
            dim_node=dataset.num_node_features, dim_hidden=args.gnn_hid_dim, num_classes=dataset.num_classes
        )
    elif args.gnn_model == "GIN_2l_BN":
        model = GIN_2l_BN(
            model_level="graph",
            dim_node=dataset.num_node_features, dim_hidden=args.gnn_hid_dim, num_classes=dataset.num_classes
        )
    elif args.gnn_model == "GIN_3l":
        model = GIN_3l(
            model_level="graph",
            dim_node=dataset.num_node_features, dim_hidden=args.gnn_hid_dim, num_classes=dataset.num_classes
        )
    elif args.gnn_model == "GIN_3l_BN":
        model = GIN_3l_BN(
            model_level="graph",
            dim_node=dataset.num_node_features, dim_hidden=args.gnn_hid_dim, num_classes=dataset.num_classes
        )
    else:
        raise ValueError("%s is not a valid gnn option." % args.gnn_model)
